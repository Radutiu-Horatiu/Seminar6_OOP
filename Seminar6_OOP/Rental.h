...
private:
	...
	std::vector<Reservierung> orders;  // List with all the orders made by the clients of the rental company
public:
	// Default Constructor
	Rental();
	...
	std::vector<Reservierung> getOrders() const;
	std::vector<Reservierung>& getOrders();
